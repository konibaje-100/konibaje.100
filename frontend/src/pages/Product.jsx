...
const Product = () => {
  ...
  const {products, essentials, currency, addToCart} = useContext(ShopContext);
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
              ...
              <p className='mt-5 text-3xl font-medium'>{currency}{productData.price} <span className='line-through text-gray-500 ml-2'>{currency}100,000</span> </p>
